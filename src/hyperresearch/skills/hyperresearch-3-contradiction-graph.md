...
- **full tier:** Invoke `<% if platform == "codex" %>cat .hyperresearch/codex/steps/hyperresearch-4-loci-analysis.md<% else %>Skill(skill: "hyperresearch-4-loci-analysis")<% endif %>`
